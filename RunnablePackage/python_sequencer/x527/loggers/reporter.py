...
class ReporterProtocol(object):
    ...
    def create_report(self, event_type, **kwargs):
        ...
        try:
            if event_type == events.SEQUENCE_START:
            ...
            elif event_type == events.SEQUENCE_END:
                r = kwargs['result']
                data = dict(result = r)
                ...
                names = ['group', 'GROUP', 'TID', 'tid', 'low', 'LOW', 'high', 'HIGH', 'unit', 'UNIT']
                ...
                raise ReportDataError('unkown event_type ' + str(event_type))
